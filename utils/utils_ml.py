...
def run_model(model, X_train, Y_train, X_test, Y_test, func_prepare_XY, exp_name, exp_params, run_id, verbose=False, **kwargs):
    """
    _summary_
    ...
    X_train_prep, Y_train_prep, X_test_prep, Y_test_prep = func_prepare_XY(X_train, Y_train, X_test, Y_test, **kwargs)
    ...
    history_df = clean_history(history)
